...
assert.equal(transition.impacted.length, 1, "Joker removes the other 9 (9d); 9h target is excluded");
...
assert.equal(humanAfter, 1, "human 9h target stays on board after ack (was 1, still 1)");
