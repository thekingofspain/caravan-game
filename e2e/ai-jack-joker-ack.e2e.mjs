...
let aiCardsBefore = await page.locator(".play-row.ai .track.ai .card").count();
...
let humanCardsBefore = await page.locator(".play-row.human .track.human .card").count();
let aiCardsBefore2 = await page.locator(".play-row.ai .track.ai .card").count();
...
let humanCardsGrey = await page.locator(".play-row.human .track.human .card.pending").count();
let aiCardsGrey = await page.locator(".play-row.ai .track.ai .card.pending").count();
...
let humanAfter = await page.locator(".play-row.human .track.human").first().locator(".card").count();
let aiAfter = await page.locator(".play-row.ai .track.ai").first().locator(".card").count();
let totalAfter = await page.locator(".play-row.human .track.human .card, .play-row.ai .track.ai .card").count();
...
assert.equal(await page.locator(".play-row.human .track.human").nth(1).locator(".card").count(), 0, "3c removed after Jack ack");
